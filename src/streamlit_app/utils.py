...
TEAM_IMAGES: Dict[str, List[str]] = {
    ...
    "Josefine": [IMG_NADJA, IMG_JANETTE, IMG_MICHELLE, IMG_YANA, IMG_KATALINA, IMG_VIVIEN],
    "Marie":    [IMG_NATALIE, IMG_VIVIEN, IMG_NADJA, IMG_LAURA, IMG_YANA, IMG_KATALINA],
    "Julian":   [IMG_NADJA, IMG_JANETTE, IMG_LAURA, IMG_KATALINA, IMG_LIA, IMG_JOSI, IMG_TIM],
    "Mert":     [IMG_LIA, IMG_KATALINA, IMG_YANA, IMG_VIVIEN, IMG_KIM, IMG_PAULINA],
    "Luisa":    [IMG_PLACEHOLDER, IMG_PLACEHOLDER, IMG_PLACEHOLDER, IMG_PLACEHOLDER, IMG_PLACEHOLDER, IMG_PLACEHOLDER],
    "Anne":     [IMG_CHIARA, IMG_LIA, IMG_KATARINA, IMG_VIVIEN, IMG_YANA, IMG_NADJA],
}
